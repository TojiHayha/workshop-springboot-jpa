package com.kamishhayha.coursek.config;
...
import com.kamishhayha.coursek.entities.Payment;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User u3 = new User(null, "GuiBert", "Gui@gmail.com", "9999999999", "123456"); 
		...
		OrderItem oi5 = new OrderItem(o2, p4, 3, p4.getPrice());
		OrderItem oi6 = new OrderItem(o4, p4, 5, p4.getPrice());
